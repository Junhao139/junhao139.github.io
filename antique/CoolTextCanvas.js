...
function cool_text_main() {
    ...
    var dot_char_array = generate_random_chars_pyramid(camera_props, new vector2(20, 20), 200, 200, accepted_char_array);
    ...
    let time_accumulation = { acculumated_time: 0 };
    setInterval(function(camera_props, dot_char_array, color_array, time_accumulation) {
        ...
        if (time_accumulation.acculumated_time < 2) {
            camera_props.pos.y = 600 * timing_function(time_accumulation.acculumated_time);
        } else {
            camera_props.pos.y = 0;
            camera_props.pos.z = 40 * time_accumulation.acculumated_time - 80;
        }
        time_accumulation.acculumated_time += 0.02;
